...
class AUTOGCNNet(nn.Module):
    def __init__(self, net_params):
        ...
        self.layers.extend([AUTOGCNLayer(hidden_dim, hidden_dim, F.relu, dropout, graph_norm, batch_norm, num_low=num_low, num_high=num_high, num_mid=num_mid, opt=opt, K=n_filters, residual=residual, gate=gate) for _ in range(n_layers)])
